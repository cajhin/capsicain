...
bool parseKeywordCombo(std::string line, int &key, MOD (&mods)[6], std::string &dev, std::vector<VKeyEvent> & strokeSequence, std::string scLabels[], std::string defaultFunction);
