...
int main()
{
		...
		)
	{
		...
		if (state.isCapsTapped && millisecondsSince(capsDownTimestamp) > CAPS_TAPPED_TIMEOUT_MS)
		{
			state.isCapsTapped = false;
			IFDEBUG cout << endl << "***Forgetting Caps tapped. Was " << dec << millisecondsSince(capsDownTimestamp) << "ms ago";
		}
